...
public class ActivityControllerTest {
	...
	public void before() {
		...
		when(mockDefaultDefaultActivityFacade.getActivity("1234")).thenReturn(activity);
	}
	
	@Test
	public void authorisedCallsAuthoriseApplicationOnAuthorisationFacade() {
		Map<String, Object> model = new HashMap<String, Object>();
		activityController.activity(model, "98765");
		verify(mockDefaultDefaultActivityFacade).getActivity("98765");
	}
